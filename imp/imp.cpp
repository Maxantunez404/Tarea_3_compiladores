...
BooleanExp::BooleanExp(bool v):value(v){}
...
int BooleanExp::accept(ImpVisitor* v){
  return v ->visit(this);
}
...
ImpType BooleanExp::accept(TypeVisitor* v){
  return v->visit(this);
}
...
//for
ForStatement::ForStatement(string id, Exp* e, Exp* e2, Body *b): id(id), e(e), e2(e2), body(b) { }
...
//for
ForStatement::~ForStatement() { delete body; delete e; delete e2; }
